...
function addRefresh(data) {
    document.getElementById("myImg").src="/static/refreshBlueButtonRed.png";
    setTimeout(loadingPage, 3000);
    setTimeout(delayFn, 6000);
}

function delayFn(){
document.getElementById("myImg").src="/static/refreshBlueButton.PNG";
const myNode = document.getElementById("chatW");
myNode.innerHTML = "";

}

function loadingPage(){
//document.getElementById("myImg").src="/static/loading.PNG";
const myNode = document.getElementById("chatW");
myNode.innerHTML =
"<img height=\"500px\" src=\"/static/loading.gif\" >";
}